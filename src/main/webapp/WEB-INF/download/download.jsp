...
<script src="/winner/files/hm.js"></script><script src="/winner/files/hm(1).js"></script><script src="/winner/files/jquery.js"></script>
...
<script src="/winner/files/echarts.js"></script>	<style type="text/css">
	.down_img{
		position:absolute;
		left:660px;
		top:250px;
...
<script type="text/javascript">
    $(function(){
	 ...
	 <div class="down">
    	...
    	<div class="down_img"><img alt="" src="/winner/files/appdownload.png" width="150px" height="150px"></div>
    	<div class="down_xz">
    	<a href="http://pro.ying158.com/download/app/ios" target="_black"><i class="iconfont"></i>IOS版本下载</a>
    	<a href="http://pro.ying158.com/download/app/android" class="android"><i class="iconfont"></i>安卓版本下载</a>
    	</div>
