...
<tr>
<td width="15%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名称:</td>
<td width="35%"><input type="text" name="name" value="${fs.name}"  class="form-control"placeholder="请输入文本"></td><td colspan="2"></td>
</tr>
<tr>
<td width="15%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;起投金额(元):</td>
<td width="35%"><input type="text" name="floorAmount" value="${fs.floorAmount}" class="form-control" placeholder="请输入文本"></td><td colspan="2"></td>
</tr>
<tr>
<td width="15%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年化收益(%):</td>
<td width="35%"><input type="text" name="yearRate" value="${fs.yearRate}" class="form-control" placeholder="请输入文本"></td><td colspan="2"></td>
</tr>
<tr>
<td width="15%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;开始日期:</td>
<td width="35%"><input type="date" name="startDate" value="${fs.startDate}" class="form-control" placeholder="请输入文本"></td><td colspan="2"></td>
</tr>
<tr>
<td width="15%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;结束日期:</td>
<td width="35%"><input type="date" name="endDate" value="${fs.endDate}" class="form-control" placeholder="请输入文本"></td><td colspan="2"></td>
</tr>
<tr>
<td width="15%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;返佣比例:</td>
<td width="35%"><input type="text" name="ratio" value="${fs.ratio}" class="form-control"placeholder="请输入文本"></td><td colspan="2"></td>
</tr>
<tr>
<td width="15%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;状态:</td>
<td width="35%">
...
<td width="35%"><input type="text" name="period" value="${fs.period}" class="form-control" placeholder="请输入文本"></td><td colspan="2"></td>
</tr>
</table>
