...
<p><p><p><h4>▶&nbsp;签署合同</h4>
<form action="/winner/yx2/upatesign/${id2}" method="post" enctype="multipart/form-data">
...
<tr>
<td width="35%" align="right">风险提示书:&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="file" name="file_name" required="required" class="form-control"></td><td></td>
</tr>
<tr>
